...
// //SVG初期設定
// function VivusInit(){
//   logoVivus1 = new Vivus('favorite_back_illust',
//     {
...
//     },
//     function(obj){
//       $("#favorite_back_illust").attr("class", "done");//描画が終わったらdoneというクラスを追加
//     }
//   );
//   logoVivus1.stop();
// }
...
//   var elemPos = $("#favorite_back_illust").offset().top - 50;//要素より、50px上の位置まで来たら出現
...
//   // console.log('test');
//   if ($('#favorite_back_illust').length) {
